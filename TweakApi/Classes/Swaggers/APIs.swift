...
public class TweakApiAPI {
    public static var basePath = "https://apidevcdn.tweak.com/api"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool) {
        ...
        addHeaders(TweakApiAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = TweakApiAPI.credential
        return self
    }
}
